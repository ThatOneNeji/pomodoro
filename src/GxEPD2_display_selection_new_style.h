...
#else
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ EPD_CS_PIN, /*DC=*/EPD_DC_PIN, /*RST=*/EPD_RST_PIN, /*BUSY=*/EPD_BUSY_PIN)); // This uses the values from config.h
